 ...
 $(document).ready(function() {
     ...
     $.get('/example', function(apiData) {
         let distanceAU = apiData.table.rows[3].cells[0].distance.from_earth.au;
         let distanceKM = apiData.table.rows[3].cells[0].distance.from_earth.km;
         ...
         $('#estimatedTime1').text('Estimated Time : ' + estimatedTime1 + ' hours');
     });
     ...
     $.get('/example', function(apiData) {
         ...
         $('#estimatedTime2').text('Estimated Time : ' + estimatedTime2 + ' day');
     });
